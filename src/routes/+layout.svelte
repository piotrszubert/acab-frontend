...
<div class="drawer">
  ...
  <div class="drawer-content flex flex-col">
    ...
    <div class="w-full navbar bg-base-300 sticky top-0 z-10">
      ...
      <div class="flex-1 px-2 mx-2 text-lg stroke-secondary font-title "><span class="lowercase text-primary font-extrabold">ac</span><span class="text-base-content font-extrabold">ab.</span></div>
