...
<div class="drawer ">
    ...
    <div class="w-full navbar bg-base-300 sticky top-0 z-10">
      ...
      <div class="flex-none hidden md:block">
        <ul class="menu menu-horizontal">
          ...
          <li class="nav-item">
              <a class="nav-link" rel="prefetch" class:underline={$page.url.pathname === '/contact'} href="/contact">Contact</a>
          </li>
          <li>
  ...
  <div class="drawer-side">
    ...
    <ul class="menu p-4 overflow-y-auto w-80 bg-base-100">
      ...
      <li class="nav-item">
        <a class="nav-link" on:click={() => handleClick()} rel="prefetch" class:underline={$page.url.pathname === '/contact'} href="/contact">Contact</a>
      </li>
